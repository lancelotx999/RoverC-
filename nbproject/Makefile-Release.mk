...
${OBJECTDIR}/tests/Battery.o: tests/Battery.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Battery.o tests/Battery.cpp

${OBJECTDIR}/tests/Devices.o: tests/Devices.cpp 
	${MKDIR} -p ${OBJECTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Devices.o tests/Devices.cpp

${OBJECTDIR}/tests/Drill.o: tests/Drill.cpp 
	${MKDIR} -p ${OBJECTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Drill.o tests/Drill.cpp

${OBJECTDIR}/tests/Object.o: tests/Object.cpp 
	${MKDIR} -p ${OBJECTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Object.o tests/Object.cpp

${OBJECTDIR}/tests/Radar.o: tests/Radar.cpp 
	${MKDIR} -p ${OBJECTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Radar.o tests/Radar.cpp

${OBJECTDIR}/tests/Rover.o: tests/Rover.cpp 
	${MKDIR} -p ${OBJECTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Rover.o tests/Rover.cpp

${OBJECTDIR}/tests/Solar.o: tests/Solar.cpp 
	${MKDIR} -p ${OBJECTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Solar.o tests/Solar.cpp
...
${TESTDIR}/tests/RoverTest.o: tests/RoverTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RoverTest.o tests/RoverTest.cpp


${TESTDIR}/tests/test_rover.o: tests/test_rover.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_rover.o tests/test_rover.cpp
...
${OBJECTDIR}/tests/Battery_nomain.o: ${OBJECTDIR}/tests/Battery.o tests/Battery.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Battery_nomain.o tests/Battery.cpp;\
	else  \
...
${OBJECTDIR}/tests/Devices_nomain.o: ${OBJECTDIR}/tests/Devices.o tests/Devices.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Devices_nomain.o tests/Devices.cpp;\
	else  \
...
${OBJECTDIR}/tests/Drill_nomain.o: ${OBJECTDIR}/tests/Drill.o tests/Drill.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Drill_nomain.o tests/Drill.cpp;\
	else  \
...
${OBJECTDIR}/tests/Object_nomain.o: ${OBJECTDIR}/tests/Object.o tests/Object.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Object_nomain.o tests/Object.cpp;\
	else  \
...
${OBJECTDIR}/tests/Radar_nomain.o: ${OBJECTDIR}/tests/Radar.o tests/Radar.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Radar_nomain.o tests/Radar.cpp;\
	else  \
...
${OBJECTDIR}/tests/Rover_nomain.o: ${OBJECTDIR}/tests/Rover.o tests/Rover.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Rover_nomain.o tests/Rover.cpp;\
	else  \
...
${OBJECTDIR}/tests/Solar_nomain.o: ${OBJECTDIR}/tests/Solar.o tests/Solar.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/Solar_nomain.o tests/Solar.cpp;\
	else  \
